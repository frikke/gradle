...
====
include::sample[dir="snippets/tutorials/running-builds/upgraded/kotlin",files="app/build.gradle.kts[tags=init-plugins]"]
include::sample[dir="snippets/tutorials/running-builds/upgraded/groovy",files="app/build.gradle[tags=init-plugins]"]
====
...
====
include::sample[dir="snippets/tutorials/running-builds/upgraded/kotlin",files="app/build.gradle.kts[tags=init-publish]"]
include::sample[dir="snippets/tutorials/running-builds/upgraded/groovy",files="app/build.gradle[tags=init-publish]"]
====
