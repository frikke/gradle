...
NOTE: Provenance is omitted from failure messages for verification failures (e.g., test failures), since those are expected outcomes rather than configuration issues.
...
====
include::sample[dir="snippets/reference/task-development/defineUsingStringTaskNames/kotlin",files="build.gradle.kts[tags=simple_register]"]
include::sample[dir="snippets/reference/task-development/defineUsingStringTaskNames/groovy",files="build.gradle[tags=simple_register]"]
====
...
====
include::sample[dir="snippets/reference/task-development/configureUsingBlock/kotlin",files="build.gradle.kts[tags=declare-task]"]
include::sample[dir="snippets/reference/task-development/configureUsingBlock/groovy",files="build.gradle[tags=declare-task]"]
====
...
[[using_the_named_method]]
==== 1. Using the `named()` method:

Use `named()` to configure an existing task registered elsewhere:

====
include::sample[dir="snippets/reference/task-development/configureUsingVar/kotlin",files="build.gradle.kts[tags=configure]"]
include::sample[dir="snippets/reference/task-development/configureUsingVar/groovy",files="build.gradle[tags=configure]"]
====

[[using_a_configuration_block]]
==== 2. Using a configuration block:

Use a block to configure the task immediately upon registering it:

====
include::sample[dir="snippets/reference/task-development/defineAndConfigure/kotlin",files="build.gradle.kts[tags=no-description]"]
include::sample[dir="snippets/reference/task-development/defineAndConfigure/groovy",files="build.gradle[tags=no-description]"]
====
