...
[[sec:implementing_a_build_service]]
...
.WebServer.java
----
include::{snippetsPath}/reference/task-development/buildService/common/buildSrc/src/main/java/WebServer.java[]
----
...
[[registering_a_build_service_via_internal_task_properties]]
=== Registering a build service to be consumed via `@Internal` task properties

[source,java]
.DownloadPlugin.java
----
include::{snippetsPath}/reference/task-development/buildService/common/buildSrc/src/main/java/DownloadPlugin.java[]
----
...
.Download.java
----
include::{snippetsPath}/reference/task-development/buildService/common/buildSrc/src/main/java/Download.java[]
----
...
[[using_shared_build_services_from_configuration_actions]]
...
[[sec:using_a_build_service_with_the_worker_api]]
...
.Download.java
----
include::{snippetsPath}/reference/task-development/buildServiceFromWorkAction/common/buildSrc/src/main/java/Download.java[]
----
...
[[sec:accessing_the_build_service_concurrently]]
