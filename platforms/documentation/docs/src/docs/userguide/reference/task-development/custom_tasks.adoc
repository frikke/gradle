...
[[taskDefinition]]
====
include::sample[dir="snippets/reference/task-development/incrementalTask/kotlin",files="build.gradle.kts[tags=incremental-task]"]
include::sample[dir="snippets/reference/task-development/incrementalTask/groovy",files="build.gradle[tags=incremental-task]"]
====
...
====
include::sample[dir="snippets/reference/task-development/incrementalTask/kotlin",files="build.gradle.kts[tags=reverse]"]
include::sample[dir="snippets/reference/task-development/incrementalTask/groovy",files="build.gradle[tags=reverse]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/task-development/incrementalTask/tests/incrementalTaskFirstRun.out[]
----
...
[source,text]
----
include::{snippetsPath}/reference/task-development/incrementalTask/tests/incrementalTaskNoChange.out[]
----
...
====
include::sample[dir="snippets/reference/task-development/incrementalTask/kotlin",files="build.gradle.kts[tags=updated-inputs]"]
include::sample[dir="snippets/reference/task-development/incrementalTask/groovy",files="build.gradle[tags=updated-inputs]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/task-development/incrementalTask/tests/incrementalTaskUpdatedInputs.out[]
----
...
====
include::sample[dir="snippets/reference/task-development/incrementalTask/kotlin",files="build.gradle.kts[tags=removed-input]"]
include::sample[dir="snippets/reference/task-development/incrementalTask/groovy",files="build.gradle[tags=removed-input]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/task-development/incrementalTask/tests/incrementalTaskRemovedInput.out[]
----
...
====
include::sample[dir="snippets/reference/task-development/incrementalTask/kotlin",files="build.gradle.kts[tags=removed-output]"]
include::sample[dir="snippets/reference/task-development/incrementalTask/groovy",files="build.gradle[tags=removed-output]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/task-development/incrementalTask/tests/incrementalTaskRemovedOutput.out[]
----
...
[source,text]
----
include::{snippetsPath}/reference/task-development/incrementalTask/tests/incrementalTaskChangedProperty.out[]
----
...
.UrlVerify.java
----
include::{snippetsPath}/reference/task-development/commandLineOption-stringOption/common/buildSrc/src/main/java/UrlVerify.java[tag=custom-task-implementation]
----
...
====
include::sample[dir="snippets/reference/task-development/commandLineOption-stringOption/kotlin",files="build.gradle.kts[tags=task]"]
include::sample[dir="snippets/reference/task-development/commandLineOption-stringOption/groovy",files="build.gradle[tags=task]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/task-development/commandLineOption-stringOption/tests/taskCommandLineOption.out[]
----
...
.UrlProcess.java
----
include::{snippetsPath}/reference/task-development/commandLineOption-optionValues/common/buildSrc/src/main/java/UrlProcess.java[tag=custom-task-implementation]
----
...
[source,text]
----
include::{snippetsPath}/reference/task-development/commandLineOption-optionValues/tests-kotlin/helpTaskOptions.kotlin.out[]
----
