...
.UrlVerify.java
----
include::{snippetsPath}/tasks/commandLineOption-stringOption/common/buildSrc/src/main/java/UrlVerify.java[tag=custom-task-implementation]
----
...
.UrlProcess.java
----
include::{snippetsPath}/tasks/commandLineOption-optionValues/common/buildSrc/src/main/java/UrlProcess.java[tag=custom-task-implementation]
----
...
[source,text]
----
include::{snippetsPath}/tasks/commandLineOption-optionValues/tests-kotlin/helpTaskOptions.kotlin.out[]
----
