...
include::sample[dir="snippets/reference/task-development/organizingTasks-appGrouping",files="app/build.gradle.kts[tags=app-grouping]"]
include::sample[dir="snippets/reference/task-development/organizingTasks-appGrouping",files="app/build.gradle[tags=app-grouping]"]
...
include::sample[dir="snippets/reference/task-development/organizingTasks-globalGroups",files="build.gradle.kts[tags=global-groups]"]
include::sample[dir="snippets/reference/task-development/organizingTasks-globalGroups",files="build.gradle[tags=global-groups]"]
...
include::sample[dir="snippets/reference/task-development/organizingTasks-globalLifecycle",files="build.gradle.kts[tags=global-lifecycle]"]
include::sample[dir="snippets/reference/task-development/organizingTasks-globalLifecycle",files="build.gradle[tags=global-lifecycle]"]
