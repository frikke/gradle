...
====
include::sample[dir="snippets/reference/platforms/jvm/quickstart/kotlin",files="build.gradle.kts[tags=dependencies]"]
include::sample[dir="snippets/reference/platforms/jvm/quickstart/groovy",files="build.gradle[tags=dependencies]"]
====
...
----
include::{snippetsPath}/reference/platforms/jvm/quickstart/common/src/main/java/org/gradle/HttpClientWrapper.java[tag=sample]
----
